...
export default function Hero() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[calc(100svh_-_var(--header-h))] max-w-page flex-col justify-center px-gutter py-section">
        ...
        >
          {/* Der Kicker als Messschild: erst der Strich, dann die
              Beschriftung. Genau die Bauform, in der weiter unten die Befunde
              stehen, damit die Seite von der ersten Zeile an eine Sprache
              spricht. */}
          ...
          {/* Zwei Wege, aber nur einer traegt Flaeche. Der Plan verlangt einen
              CTA, der Inhalt liefert zwei: der zweite ist deshalb ein
              Textlink und keine zweite Schaltflaeche gleichen Gewichts. Wer
              zwei gleich laute Knoepfe hinstellt, hat keinen lauten mehr.
              gap-y sorgt dafuer, dass beide im schmalen Fenster untereinander
              genug Luft behalten, ohne dass der Link am Knopf klebt. */}
          <div
